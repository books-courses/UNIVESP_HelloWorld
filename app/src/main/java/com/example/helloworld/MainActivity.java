...
public class MainActivity extends AppCompatActivity {
    ...
    // Acessar site por meio de uma activiti, em um browser
    ...
    private class MinhaAsync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            // Vamos evocar o método downloadXMLFile passando a url como parâmetro
            mensagem = downloadXMLFile(params[0]);

            // Aviso para ser exibido no Logcat caso tenha havido problema no download
            if (mensagem == null) {
